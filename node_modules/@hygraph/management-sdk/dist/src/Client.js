        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (process.env.DEBUG)
                    console.log("Checking request to:", mgmtClientUrl);
                yield (0, graphql_request_1.request)(mgmtClientUrl, `{ metaInfo { serverVersion } }`);
            }
            catch (error) {
                if (error instanceof graphql_request_1.ClientError && error.response.status === 404) {
            ...
            if (process.env.DEBUG)
                console.log("Finally, sending request to:", mgmtClientUrl);
            const client = new ManagementAPIClient_1.ManagementAPIClient(this.endpoint, mgmtClientUrl, this.authToken);
            let result;
            try {
